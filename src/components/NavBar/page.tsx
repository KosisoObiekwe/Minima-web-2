...
export default function NavBar () {
    return (
        <main className="sticky">
            <nav className="sticky bg-black outline outline-white px-5 py-3 sm:px-10 sm:py-5 md:px-15 md:py-5 lg:px-20 lg:py-8 xl:px-30 xl:py-8 outline-none">
                <div className="flex justify-between items-center lg:flex-row lg:justify-between">
                    ...
                    <div>
                        <ul className="hidden lg:block lg:flex lg:space-x-10 xl:space-x-15 2xl:space-x-20 ">
