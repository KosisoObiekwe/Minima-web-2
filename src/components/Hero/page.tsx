...
export default  function Hero () {
    return (
        <main className="mt-20">
            <section className="relative border-2 border-white border-none w-full h-full">
                ...
                <div className="relative z-20 ">
                    <div className="lg:-space-y-10 xl:-space-y-10 relative">
                        ...
                        <div className="absolute font-light top-90 left-4 sm:left-70 sm:top-90 md:left-93 lg:top-105 lg:left-130 xl:top-130 xl:left-160 2xl:top-150 2xl:left-200">
